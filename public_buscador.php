...
<body>
    <div class="contenedor">
        <div class="encabezado">
            ...
            <p>Sistema de Consulta Pública - Instituto IESHUANTA</p>
        </div>
    ...
    <script>
        // Token oculto en el código JavaScript
        const TOKEN_VALIDO = 'cd2de76a3fc6a818fbd0fb1a97e94961-2';
        // También puedes usar el otro token: '676e825340db2c338f23bcf57882f347-1'
        ...
        function buscarEstudiantes(dni, nombre, apellido) {
            ...
            // Construir URL de la API pública con token OCULTO
            const parametros = new URLSearchParams();
            parametros.append('token', TOKEN_VALIDO); // Token oculto
            if (dni) parametros.append('dni', dni);
            if (nombre) parametros.append('nombre', nombre);
            if (apellido) parametros.append('apellido', apellido);
            
            const url = `api_estudiantes.php?${parametros.toString()}`;
